...
Data.Config = {expansionLevel = 11, mode = "merge"}

local function getCategoryId(name, ...)
    _.forEach({...}, function(v) name = name .. " " .. L[v] end)
    return name:gsub(" ", "_")
end

Data.Items = {
    [getCategoryId("enchants", "HEAD")] = {
        {["id"] = {243978, 243979}}, -- Enchant Helm - Blessing of Speed
        {["id"] = {243980, 243981}}, -- Enchant Helm - Empowered Blessing of Speed
        {["id"] = {243950, 243951}}, -- Enchant Helm - Empowered Hex of Leeching
        {["id"] = {244006, 244007}}, -- Enchant Helm - Empowered Rune of Avoidance
        {["id"] = {243948, 243949}}, -- Enchant Helm - Hex of Leeching
        {["id"] = {244004, 244005}} -- Enchant Helm - Rune of Avoidance
    },
    [getCategoryId("enchants", "SHOULDER")] = {
        ...
        {["id"] = {243962, 243963}}, -- Enchant Shoulders - Akil'zon's Swiftness
        {["id"] = {243990, 243991}}, -- Enchant Shoulders - Amirdrassil's Grace
        {["id"] = {243960, 243961}}, -- Enchant Shoulders - Flight of the Eagle
        {["id"] = {243988, 243989}}, -- Enchant Shoulders - Nature's Grace
        {["id"] = {244020, 244021}}, -- Enchant Shoulders - Silvermoon's Mending
        {["id"] = {244018, 244019}}, -- Enchant Shoulders - Thalassian Recovery
    },
